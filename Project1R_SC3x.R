...
Cs = 3*129500000                     # sediment solid concentration, ug/kg (given)
...
vgw = 198 / 365                    # converts groundwater velocity into cm/day
...
fac = 0.0028                        # activated carbon fraction (play around with this)
